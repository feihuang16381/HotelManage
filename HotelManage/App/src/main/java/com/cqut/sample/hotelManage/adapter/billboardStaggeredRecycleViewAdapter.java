 ...
 */
public class billboardStaggeredRecycleViewAdapter extends RecyclerView.Adapter<billboardStaggeredRecycleViewAdapter.ViewHolder> {
    ...
    public billboardStaggeredRecycleViewAdapter(Context context, List<Map<String, String>> dataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hotel_sthird, parent, false);
        mGoodView = new GoodView(mContext);
        final billboardStaggeredRecycleViewAdapter.ViewHolder holder = new billboardStaggeredRecycleViewAdapter.ViewHolder(v);
