...
public class BrowsehisAdapter extends RecyclerView.Adapter<BrowsehisAdapter.ViewHolder>{
    ...
    public BrowsehisAdapter(Context context, List<Map<String, String>> dataList) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            dddView =itemView;
            mContentBanner = itemView.findViewById(R.id.banner_guide_content);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.browsehis_reclerviewitem, parent, false);
        mGoodView = new GoodView(mContext);

        final BrowsehisAdapter.ViewHolder holder = new BrowsehisAdapter.ViewHolder(v);
