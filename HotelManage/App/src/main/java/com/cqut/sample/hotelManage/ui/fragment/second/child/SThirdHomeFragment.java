...
public class SThirdHomeFragment extends SupportFragment {
    ...
    public static SThirdHomeFragment newInstance() {
        Bundle args = new Bundle();
        SThirdHomeFragment fragment = new SThirdHomeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new billboardStaggeredRecycleViewAdapter(getContext(), setList());
