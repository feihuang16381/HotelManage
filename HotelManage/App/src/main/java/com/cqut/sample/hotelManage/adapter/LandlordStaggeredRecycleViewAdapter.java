 ...
 */
public class LandlordStaggeredRecycleViewAdapter extends RecyclerView.Adapter<LandlordStaggeredRecycleViewAdapter.ViewHolder> {
    ...
    public LandlordStaggeredRecycleViewAdapter(Context context, List<Map<String, String>> dataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.collect_landlord, parent, false);
        mGoodView = new GoodView(mContext);
        final LandlordStaggeredRecycleViewAdapter.ViewHolder holder = new LandlordStaggeredRecycleViewAdapter.ViewHolder(v);
